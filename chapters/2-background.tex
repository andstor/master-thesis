...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.66\textwidth]{figures/transformer-architecture.png}
...
\begin{figure}[ht]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \centering
        \includegraphics[width=0.6\textwidth, keepaspectratio]{figures/scaled-dotproduct-attention.png}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \centering
        \includegraphics[width=\textwidth, keepaspectratio]{figures/multihead-attention.png}
